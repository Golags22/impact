      ...
      <footer className="bg-gray-800 text-gray-300">
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            {/* About Section */}
            <div>
              <h3 className="text-lg font-bold text-white mb-4">Impact for Success Foundation</h3>
              <p className="text-sm">
                Dedicated to empowering communities through education, healthcare, and sustainable development.
              </p>
          ...
          <div className="text-center mt-8 border-t border-gray-700 pt-4">
            <p className="text-sm">&copy; 2024 Impact for Success Foundation. All rights reserved.</p>
          </div>
        </div>
      </footer>
    );
